...
starship   );
  ...
  void addAll(covariant SearchResult other, { bool overwrite = true, }) {
...
class _CharacterFields   {
  ...
  /// 
  /// pre-existing values are not overwritten unless `overwrite: true`
  void addAll(covariant _CharacterFields other, { bool overwrite = true, }) {
    assert(other != null, "Cannot add all from null into $this");
    if (overwrite != null && overwrite){
...
class _QueryFields   {
  ...
  /// 
  /// pre-existing values are not overwritten unless `overwrite: true`
  void addAll(covariant _QueryFields other, { bool overwrite = true, }) {
    assert(other != null, "Cannot add all from null into $this");
    if (overwrite != null && overwrite){
...
class _FriendsConnectionFields   {
  ...
  /// 
  /// pre-existing values are not overwritten unless `overwrite: true`
  void addAll(covariant _FriendsConnectionFields other, { bool overwrite = true, }) {
    assert(other != null, "Cannot add all from null into $this");
    if (overwrite != null && overwrite){
...
class _FriendsEdgeFields   {
  ...
  /// 
  /// pre-existing values are not overwritten unless `overwrite: true`
  void addAll(covariant _FriendsEdgeFields other, { bool overwrite = true, }) {
    assert(other != null, "Cannot add all from null into $this");
    if (overwrite != null && overwrite){
...
class _PageInfoFields   {
  ...
  /// 
  /// pre-existing values are not overwritten unless `overwrite: true`
  void addAll(covariant _PageInfoFields other, { bool overwrite = true, }) {
    assert(other != null, "Cannot add all from null into $this");
    if (overwrite != null && overwrite){
...
class _ReviewFields   {
  ...
  /// 
  /// pre-existing values are not overwritten unless `overwrite: true`
  void addAll(covariant _ReviewFields other, { bool overwrite = true, }) {
    assert(other != null, "Cannot add all from null into $this");
    if (overwrite != null && overwrite){
...
/// 
class _HumanFields  implements CharacterFields  {
  ...
  /// 
  /// pre-existing values are not overwritten unless `overwrite: true`
  void addAll(covariant _HumanFields other, { bool overwrite = true, }) {
    assert(other != null, "Cannot add all from null into $this");
    if (overwrite != null && overwrite){
...
class _StarshipFields   {
  ...
  /// 
  /// pre-existing values are not overwritten unless `overwrite: true`
  void addAll(covariant _StarshipFields other, { bool overwrite = true, }) {
    assert(other != null, "Cannot add all from null into $this");
    if (overwrite != null && overwrite){
...
/// 
class _DroidFields  implements CharacterFields  {
  ...
  /// 
  /// pre-existing values are not overwritten unless `overwrite: true`
  void addAll(covariant _DroidFields other, { bool overwrite = true, }) {
    assert(other != null, "Cannot add all from null into $this");
    if (overwrite != null && overwrite){
...
class _MutationFields   {
  ...
  /// 
  /// pre-existing values are not overwritten unless `overwrite: true`
  void addAll(covariant _MutationFields other, { bool overwrite = true, }) {
    assert(other != null, "Cannot add all from null into $this");
    if (overwrite != null && overwrite){
...
class _SubscriptionFields   {
  ...
  /// 
  /// pre-existing values are not overwritten unless `overwrite: true`
  void addAll(covariant _SubscriptionFields other, { bool overwrite = true, }) {
    assert(other != null, "Cannot add all from null into $this");
    if (overwrite != null && overwrite){
