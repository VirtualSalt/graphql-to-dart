...
{      @required String id,
  ...
  Search_StarshipInlineFragment copy() => Search_StarshipInlineFragment.empty()..addAll(this);
  ...
  Map<String, dynamic> toJson() => _$Search_StarshipInlineFragmentToJson(this)
    ..['__typename'] = typeName;
...
class SearchSearchCopyForTesting extends SearchResult  {
  ...
  SearchSearchCopyForTesting copy() => SearchSearchCopyForTesting.empty()..addAll(this);
  ...
  Map<String, dynamic> toJson() => _$SearchSearchCopyForTestingToJson(this)
    ..['__typename'] = typeName;
...
{      @required String id,
  ...
  SearchStarshipInlineFragment copy() => SearchStarshipInlineFragment.empty()..addAll(this);
  ...
  Map<String, dynamic> toJson() => _$SearchStarshipInlineFragmentToJson(this)
    ..['__typename'] = typeName;
...
class SearchQuery extends Query  {
  static final String typeName = "query";
    ...
    set search (List<SearchSearch> search) => fields.search = search;  @JsonKey(name: r'__searchCopyForTesting', required: false, disallowNullValue: false)
