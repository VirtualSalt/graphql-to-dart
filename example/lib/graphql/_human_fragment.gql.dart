...
mixin Home on Human  {
  static final String typeName = "Human";
    ...
    set home (String home) => fields.homePlanet = home;  @JsonKey(name: r'planet', required: false, disallowNullValue: false)
    String planet;

  /// Copies fields from [other] into a new `Home`
  static HomeSelectionSet from(Human other) =>
    HomeSelectionSet.from(other);
...
{      String home,
  ...
  Map<String, dynamic> toJson() => _$HomeSelectionSetToJson(this)
    ..['__typename'] = typeName;
...
{      double height,
  ...
  Map<String, dynamic> toJson() => _$DimensionsSelectionSetToJson(this)
    ..['__typename'] = typeName;
...
{      @required String name,
  ...
  Map<String, dynamic> toJson() => _$RelationshipsStarshipsToJson(this)
    ..['__typename'] = typeName;
...
{      @required String name,
  ...
  Map<String, dynamic> toJson() => _$RelationshipsFriendsToJson(this)
    ..['__typename'] = typeName;
...
{      List<RelationshipsFriends> friends,
  ...
  RelationshipsSelectionSet copy() => RelationshipsSelectionSet.empty()..addAll(this);
  ...
  Map<String, dynamic> toJson() => _$RelationshipsSelectionSetToJson(this)
    ..['__typename'] = typeName;
...
mixin Info on Human implements Dimensions, Home  {
  ...
  static InfoSelectionSet from(Human other) =>
    InfoSelectionSet.from(other);
...
{      double height,
  ...
  Map<String, dynamic> toJson() => _$InfoSelectionSetToJson(this)
    ..['__typename'] = typeName;
