...
{      @required List<Episode> appearsIn,
  ...
  HeroForEpisodeHumanInlineFragment copy() => HeroForEpisodeHumanInlineFragment.empty()..addAll(this);
  ...
  Map<String, dynamic> toJson() => _$HeroForEpisodeHumanInlineFragmentToJson(this)
    ..['__typename'] = typeName;
...
{      String primaryFunction,
  ...
  HeroForEpisodeDroidInlineFragment copy() => HeroForEpisodeDroidInlineFragment.empty()..addAll(this);
  ...
  Map<String, dynamic> toJson() => _$HeroForEpisodeDroidInlineFragmentToJson(this)
    ..['__typename'] = typeName;
...
{      @required String name,
  ...
  Map<String, dynamic> toJson() => _$HeroForEpisodeHeroToJson(this)
    ..['__typename'] = typeName;
...
{      HeroForEpisodeHero hero,
  ...
  Map<String, dynamic> toJson() => _$HeroForEpisodeQueryToJson(this)
    ..['__typename'] = typeName;
